  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Q3 Financial Overview</h1>
          <p className="text-gray-600 mt-1">Project management dashboard - Spreadsheet 3</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-l-4 border-l-blue-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Active tasks in pipeline</p>
          </CardContent>
        </Card>
